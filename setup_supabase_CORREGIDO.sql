-- Script CORREGIDO para configurar las tablas en tu proyecto de Supabase
-- Proyecto: kgzqliseokkckbcjvdyx
-- URL: https://kgzqliseokkckbcjvdyx.supabase.co
-- ✅ VERSIÓN CORREGIDA - Sin errores de JSONB
...
-- ✅ Insertar datos de frecuencia cardíaca (CORREGIDO)
INSERT INTO health_data (user_id, device_id, metric_type, value, recorded_at, metadata) VALUES 
    ('12345678-1234-1234-1234-123456789012', 'galaxy-watch-6', 'heart_rate', '72', NOW() - INTERVAL '23 hours', '{"source": "samsung_health", "accuracy": 95}'::jsonb),
    ('12345678-1234-1234-1234-123456789012', 'galaxy-watch-6', 'heart_rate', '68', NOW() - INTERVAL '22 hours', '{"source": "samsung_health", "accuracy": 92}'::jsonb),
    ('12345678-1234-1234-1234-123456789012', 'galaxy-watch-6', 'heart_rate', '75', NOW() - INTERVAL '21 hours', '{"source": "samsung_health", "accuracy": 98}'::jsonb),
    ('12345678-1234-1234-1234-123456789012', 'galaxy-watch-6', 'heart_rate', '70', NOW() - INTERVAL '20 hours', '{"source": "samsung_health", "accuracy": 94}'::jsonb),
    ('12345678-1234-1234-1234-123456789012', 'galaxy-watch-6', 'heart_rate', '73', NOW() - INTERVAL '19 hours', '{"source": "samsung_health", "accuracy": 96}'::jsonb),
    ('12345678-1234-1234-1234-123456789012', 'galaxy-watch-6', 'heart_rate', '69', NOW() - INTERVAL '2 hours', '{"source": "samsung_health", "accuracy": 97}'::jsonb),
    ('12345678-1234-1234-1234-123456789012', 'galaxy-watch-6', 'heart_rate', '74', NOW() - INTERVAL '1 hour', '{"source": "samsung_health", "accuracy": 99}'::jsonb),
    ('12345678-1234-1234-1234-123456789012', 'galaxy-watch-6', 'heart_rate', '71', NOW(), '{"source": "samsung_health", "accuracy": 98}'::jsonb);

-- ✅ Insertar actividad de hoy (CORREGIDO)
...
INSERT INTO daily_activity (user_id, device_id, activity_date, steps, distance_meters, calories_burned, active_minutes, floors_climbed, metadata)
VALUES ('12345678-1234-1234-1234-123456789012', 'galaxy-watch-6', CURRENT_DATE - INTERVAL '1 day', 7230, '5100', 298, 38, 8, '{}'::jsonb)
ON CONFLICT (user_id, activity_date) DO NOTHING;

-- ✅ Insertar sesión de sueño de anoche (CORREGIDO)
...
VALUES ('12345678-1234-1234-1234-123456789012', 'galaxy-watch-6', 
        ...
        '{"source": "samsung_health", "environment": "bedroom", "temperature": 22}'::jsonb);
